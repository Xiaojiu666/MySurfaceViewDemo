...
import static com.view.lib.xbr.Color.*;
import static com.view.lib.xbr.Color.makePixel;
...
abstract class AbstractScaler implements Scaler {
    ...
    protected AbstractScaler(int scale, boolean withAlpha) {
        this(scale, withAlpha ? ColorGradient.gradientARGB() : ColorGradient.gradientRGB());
    }
