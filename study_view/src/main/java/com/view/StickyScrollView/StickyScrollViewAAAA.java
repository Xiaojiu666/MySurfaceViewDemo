 ...
 *
 */
public class StickyScrollViewAAAA extends ScrollView {
	...
	public StickyScrollViewAAAA(Context context) {
		this(context, null);
	}

	public StickyScrollViewAAAA(Context context, AttributeSet attrs) {
		this(context, attrs, android.R.attr.scrollViewStyle);
	}

	public StickyScrollViewAAAA(Context context, AttributeSet attrs, int defStyle) {
